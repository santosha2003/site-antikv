...
<div class="content-block content-block-subscribe">
	<h3>РџРѕРґРїРёСЃРєР° РЅР° РЅРѕРІРѕСЃС‚Рё</h3>
	
	<form action="/personal/subscribe/" method="post">

	<div id="subscribe" class="form-box">
		<div class="form-textbox">
			<div class="form-textbox-border"><input type="text" value="РІРІРµРґРёС‚Рµ РІР°С€ e-mail" onblur="if (this.value=='')this.value='РІРІРµРґРёС‚Рµ РІР°С€ e-mail'" onclick="if (this.value=='РІРІРµРґРёС‚Рµ РІР°С€ e-mail')this.value=''" name="sf_EMAIL" /></div>
		</div>
		<div class="form-button">
			<input type="submit" value="РџРѕРґРїРёСЃР°С‚СЊСЃСЏ" />
		</div>
	</div>
