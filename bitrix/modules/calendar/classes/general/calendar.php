...
//					$toTs = self::Timestamp($_REQUEST['date_to']);
	...
	{
		$arOpt = array('work_time_start', 'work_time_end', 'year_holidays', 'year_workdays', 'week_holidays', 'week_start', 'user_name_template', 'user_show_login', 'path_to_user', 'path_to_user_calendar', 'path_to_group', 'path_to_group_calendar', 'path_to_vr', 'path_to_rm', 'rm_iblock_type', 'rm_iblock_id', 'vr_iblock_id', 'denied_superpose_types', 'pathes_for_sites', 'pathes', 'dep_manager_sub', 'forum_id');
...
//	}
	...
	public static function GetMeetingSection($userId, $autoCreate = false)
	{
		...
		if ($userId > 0)
		{
			...
			if($result && !CCalendarSect::GetById($result, true, false))
				$result = false;
	...
	public static function GetCurrentOffsetUTC($userId)
	{
