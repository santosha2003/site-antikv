...
$MESS["CES_NOTES11"] = "El archivo que lanzará el script de exportación para ejecutar las tareas con el cron es";
$MESS["CES_NOTES12"] = "ASegúrese de que el archivo contiene la ruta correcta al PHP y a la raiz del sitio";
...
$MESS["CES_NOTES5"] = "PAra fijar el archivo de confiduración usted se debe conectar a su sitio vía SSH, SSH2 o cualquier otro protocolo similar que su proveedor soporte para operaciones en el shelll remoto. In command line, run the command";
