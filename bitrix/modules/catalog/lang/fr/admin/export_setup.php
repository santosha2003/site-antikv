...
$MESS ['CES_SUCCESS'] = "opération accomplie avec succès.";
...
$MESS ['CES_SHOW_VARS_LIST_DESCR'] = "Les variables  énumèrées pour ce profil d'exportation";
...
$MESS ['CES_NOTES1'] = "Les agents sont des fonctions de PHP qui sont dirigées périodiquement à un intervalle donné. La chaque fois une page est demandée, le système vérifie automatiquement pour les agents qui ont besoin d'être exécutés et les dirigent. On ne recommande pas d'assigner d'assez longs ou grands travaux d'exportation aux agents. Vous devriez utiliser le démon cron de ce but.";
...
$MESS ['CES_NOTES4'] = "dans cron. Ce dossier contient des instructions pour les opérations d'exportation. Après le changement de tâches cron, vous devez installer le dossier de configuration de nouveau.";
$MESS ['CES_NOTES5'] = "Pour mettre le dossier à la configuration vous devez communiquer à votre site via le SSH ou SSH2 ou autre protocole semblable que votre pourvoyeur soutient pour la coquille des opérations lointaines. Dans la ligne de commande, dirigée l'ordre";
...
$MESS ['CES_NOTES10'] = "Attention! Cela enlèvera aussi n'importe quelles tâches n'existant pas dans le dossier de configuration.";
...
$MESS ['export_setup_cat'] = "Les scripts d'exportation sont localisés dans la chemise :";
$MESS ['export_setup_script'] = "Le script d'exportation";
$MESS ['export_setup_name'] = "Nom";
$MESS ['export_setup_file'] = "Dossier";
$MESS ['export_setup_begin'] = "Commencez l'exportation de données";
?>