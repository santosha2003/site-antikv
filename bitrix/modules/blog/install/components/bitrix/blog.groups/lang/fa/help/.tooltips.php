...
$MESS["SORT_ORDER2_TIP"] = "Specifies the sorting order for the second sorting pass.";
$MESS["PATH_TO_GROUP_TIP"] = "The path to the blog group page. Example: blog_g_blog.php?page=group&group_id=#group_id#.";
$MESS["GROUP_VAR_TIP"] = "Specify here the name of a variable to which the blog group ID will be passed.";
