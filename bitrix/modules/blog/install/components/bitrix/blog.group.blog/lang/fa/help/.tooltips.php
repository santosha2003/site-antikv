...
$MESS["SHOW_BLOG_WITHOUT_POSTS_TIP"] = "If the option is active, empty blogs (without i.e. messages) will be displayed as well.";
...
$MESS["ID_TIP"] = "Specifies the code in which the blog group ID will be passed.";
