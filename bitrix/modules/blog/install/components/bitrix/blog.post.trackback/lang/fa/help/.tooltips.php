...
$MESS["PATH_TO_TRACKBACK_TIP"] = "The full path to a post trackback page. Example: <nobr>/blog/blog_p_track_get.php?page=trackback&blog=#blog#&post_id=#post_id#.</nobr>";
?>