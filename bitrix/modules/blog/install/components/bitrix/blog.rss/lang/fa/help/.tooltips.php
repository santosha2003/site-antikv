...
$MESS["TYPE_TIP"] = "Select here the export format. If you choose <nobr><b>(other)-></b></nobr>, remember to specify the required format in the next field.";
...
$MESS["PATH_TO_BLOG_TIP"] = "The path to a mail blog page. Example: <nobr>/blog/blog_blog.php?page=blog&blog=#blog#.</nobr>";
