...
$MESS["PATH_TO_POST_TIP"] = "The path to a blog post details page. Example: <nobr>blog_blog.php?page=post&blog=#blog#&post_id=#post_id#.</nobr>";
...
$MESS["PATH_TO_DRAFT_TIP"] = "The path to the draft posts page.";
