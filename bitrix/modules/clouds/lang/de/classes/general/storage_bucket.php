...
$MESS["CLO_STORAGE_DB_DELETE_ERROR"] = "Der Cloud-Bucket wurde gelöscht, aber die Bucket-Beschreibung konnte aus der Datenbank nicht gelöscht werden.";
$MESS["CLO_STORAGE_CLOUD_DELETE_ERROR"] = "Fehler beim Löschen von Bucket: #error_msg#.";
$MESS["CLO_STORAGE_CLOUD_BUCKET_NOT_EMPTY"] = "Fehler beim Löschen von Bucket: Im Container sind immer noch Dateien enthalten.";
$MESS["CLO_STORAGE_UNKNOWN_SERVICE"] = "Unbekannter Service";
$MESS["CLO_STORAGE_CLOUD_ADD_ERROR"] = "Fehler bei der Erstellung eines Buckets: #error_msg#.";
?>