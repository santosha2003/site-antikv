...
#CREATED_USER_LOGIN# — логін автора звернення
#CREATED_USER_EMAIL# — e-mail автора звернення
#CREATED_USER_NAME# — ім’я автора звернення
...
Коли буде прострочено — #EXPIRATION_DATE# (залишилось: #REMAINED_TIME#)
...
#GUEST_ID# — ID гостя
";
$MESS["SUP_SE_TICKET_CHANGE_FOR_TECHSUPPORT_TEXT"] = "#ID# - ID звернення
#LANGUAGE_ID# - ідентифікатор мови сайту до якого прив'язано звернення
#WHAT_CHANGE# - список того що в зверненні змінилося
#DATE_CREATE# - дата створення
...
#PUBLIC_EDIT_URL# - посилання для зміни звернення (в публічну частину)
...
#CREATED_USER_ID# - ID автора звернення
#CREATED_USER_LOGIN# - логін автора звернення
#CREATED_USER_EMAIL# - email автора звернення
#CREATED_USER_NAME# - ім'я автора звернення
#CREATED_MODULE_NAME# - ідентифікатор модуля засобами якого було створено звернення
#CREATED_TEXT# - [#CREATED_USER_ID#] (#CREATED_USER_LOGIN#) #CREATED_USER_NAME#

#MODIFIED_USER_ID# - ID змінившого звернення
#MODIFIED_USER_LOGIN# - логін змінившого звернення
#MODIFIED_USER_EMAIL# - EMail змінившого  звернення
#MODIFIED_USER_NAME# - ім'я змінившого  звернення
...
#RATE# - оцінка відповідей
#SLA# - рівень техпідтримки
#SOURCE# - початковий джерело звернення (web, email, телефон і т.д.)
#ADMIN_EDIT_URL# - посилання для зміни звернення (в адміністративну частину)
...
#CREATED_MODULE_NAME# - ідентифікатор модуля засобами якого було створено звернення
#CREATED_TEXT# - [#CREATED_USER_ID#] (#CREATED_USER_LOGIN#) #CREATED_USER_NAME#
#MESSAGE_BODY# - текст повідомлення клієнта вимагає відповіді";
?>