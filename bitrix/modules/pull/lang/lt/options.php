...
$MESS["PULL_OPTIONS_PATH_TO_LISTENER_MODERN_DESC"] = "Atkreipkite dëmësá, jog ðiuolaikinës narðyklës gali prisijungti prie eiliø serverio esanèiam kitame serveryje ir su kitu domenu (CORS uþklausos).";
$MESS["PULL_OPTIONS_HEAD_PUB"] = "Adreso nustatymas komandø siuntimui";
$MESS["PULL_OPTIONS_HEAD_SUB_MODERN"] = "Adreso nustatymai komandø skaitymui ðiuolaikinëms narðyklëms";
$MESS["PULL_OPTIONS_HEAD_SUB"] = "Adreso nustatymai komandø skaitymui pasenusioms narðyklëms";
$MESS["PULL_OPTIONS_HEAD_SUB_MOB"] = "Adreso nustatymai komandø skaitymui mobilioms narðyklëms";
$MESS["PULL_OPTIONS_HEAD_SUB_WS"] = "Adreso nustatymai komandø skaitymui narðyklëms su Web Socket palaikymu";
$MESS["PULL_OPTIONS_HEAD_BLOCK"] = "Neleisti modulio darbà nustatytuose svetainëse";
?>