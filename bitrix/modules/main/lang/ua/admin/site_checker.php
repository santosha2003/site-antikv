...
В якості індикатора кодування для всіх модулів 1С-Бітрікс є константа <i> BX_UTF </i>. Для сайту в UTF-8 необхідно встановити в <i> /bitrix/php_interface/dbconn.php </i> код:
<code> define ('BX_UTF', true);</code>";
...
$MESS["SC_HELP_CHECK_UPLOAD_BIG"] = "Завантажується бінарний файл розміром більше 4Мб. Якщо при цьому відпрацював попередній тест завантаження файлу, можливо, спрацювало обмеження php.ini <b> post_max_size </b> або <b> upload_max_filesize </b>. Уточнити значення можна в phpinfo (Настройки - Інструменти - Налаштування PHP).
...
Якщо хостер надає альтернативні способи відправки пошти з сайту, їх можна використовувати через функцію custom_mail. Визначте цю функцію у файлі <i>/bitrix/php_interface/dbconn.php </i>, вона буде використовуватися замість вбудованої mail функції з тим же набором параметрів.";
...
Для вирішення проблем із завантаженням файлів необхідно звернутися до хостера або, для локальної установки, самостійно налаштувати сервер для передачі пошти.";
...
$MESS["SC_HELP_CHECK_LOCALREDIRECT"] = "Адміністративна частина 1С-Бітрікс працює так, що після всіх збережень форм відбувається перенаправлення на вихідну сторінку. Це дозволяє уникнути повторної передачі даних при оновленні сторінки. Щоб коректно відпрацювало перенаправлення, веб сервер повинен коректно визначати цілий ряд змінних. Також повинна бути можливість перевизначити заголовки HTTP відповіді.
...
$MESS["SC_HELP_CHECK_SECURITY"] = "Модуль Apache mod_security подібно модулю php suhosin покликаний захищати сайт від атак хакерів, але на практиці він частіше перешкоджає нормальній роботі сайту. Рекомендується його відключити, замість нього використовувати модуль проактивного захисту 1С-Бітрікс.";
...
$MESS["SC_HELP_CHECK_MYSQL_MODE"] = "Параметр <i>sql_mode </i> задає режим роботи MySQL. Може приймати значення, несумісні з 1С-Бітрікс. Щоб встановити режим роботи за умовчанням,додайте в <i>/bitrix/php_interface/after_connect.php</i>:
...
$MESS["SC_STRLEN_FAIL"] = "Строкові функції працюють некоректно";
$MESS["SC_T_RECURSION"] = "Розмір стека і pcre.recursion_limit";
$MESS["SC_HELP_CHECK_PCRE_RECURSION"] = "Параметр <i> pcre.recursion_limit </ i> за умовчанням має значення 100000. Якщо він перевищує системний розмір стека (звичайно 8 Мб), то PHP падає з помилкою <i> Segmentation fault </ i> при виконанні складних регулярних виразів.

Зняти обмеження на розмір стека можна в скрипті запуску Apache викликом: <code> ulimit-s unlimited </ code>
Якщо це неможливо, треба зменшити параметр <i> pcre.recursion_limit </ i> до 14000 або нижче.

У цьому випадку PHP падати не буде, але обробка рядків буде працювати не завжди правильно: наприклад, можуть з'являтися порожні повідомлення на форумі. ";
...
$MESS["SC_CHECK_TABLES_STRUCT_ERRORS"] = "Структура бази даних має помилки (немає таблиць: #NO_TABLES#, немає полів: #NO_FIELDS#, поля відрізняються: #DIFF_FIELDS #, немає індексів: #NO_INDEXES#). Всього #VAL#, автоматично можуть бути виправлені: #VAL1#.";
...
$MESS["SC_HELP_CHECK_CONNECT_MAIL"] = "Щоб отримувати повідомлення про нові поштових повідомленнях безпосередньо з корпоративного порталу, необхідно щоб користувач вказав дані підключення до своєї поштової скриньки зі своєю особистої сторінки налаштувань порталу.";
...
$MESS["MAIN_SC_TEST_SSL1"] = "Безпечне підключення HTTPS встановлено, але валідність SSL сертифікату перевірити не вдалося через те, що не отримана актуальний список центрів сертифікації з сайту \"1С-Бітрікс\"";
...
$MESS["MAIN_NO_PULL_MODULE"] = "Модуль Push and Pull не встановлений. PUSH повідомлення не будуть приходити на мобільні пристрої.";
$MESS["MAIN_NO_OPTION_PULL"] = "Не включена опція модуля Push and Pull відправки PUSH повідомлень. PUSH повідомлення не будуть приходити на мобільні пристрої.";
...
$MESS["SC_GR_FIX"] = "Виправлення помилок бази даних";
...
$MESS["MAIN_SC_WARNINGS"] = "повідомлення користувачам на мобільні пристрої";
...
$MESS["MAIN_SC_MAIL_TEST"] = "Відправка поштових повідомлень";
$MESS["MAIN_SC_CLOUD_TEST"] = "Доступ до хмарних сервісів 1С-Бітрікс";
...
$MESS["MAIN_SC_NO_ACCESS"] = "Немає доступу до сайту \"1С-Бітрікс\", не буде працювати система оновлень і хмарні сервіси \"1С-Бітрікс";
...
$MESS["MAIN_SC_TEST_PUSH"] = "Сповіщення користувачам на мобільні пристрої (push повідомлення)";
...
$MESS["MAIN_SC_NO_PULL_EXTERNAL"] = "Зовнішнє підключення до порталу є, але немає доступу до порту читання повідомлень модуля nginx-push-stream, миттєві повідомлення в мобільному додатку працювати не будуть.";
