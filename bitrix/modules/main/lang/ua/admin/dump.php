...
$MESS["MAIN_DUMP_NOT_INSTALLED"] = "Не встановлений PHP модуль Mcrypt";
$MESS["MAIN_DUMP_NO_ENC_FUNCTIONS"] = "Функції шифрування недоступні, використання хмарного сховища «1С-Бітрікс» неможливе. Зверніться до системного адміністратора для вирішення проблеми";
...
$MESS["DUMP_MAIN_BITRIX_CLOUD"] = "хмара «1С-Бітрікс»";
...
$MESS["DUMP_MAIN_MULTISITE"] = "Якщо <a href=/bitrix/admin/site_admin.php target=_blank> налаштовано</a> кілька сайтів з різними шляхами до кореневої папці веб-сервера, вони архівуються і відновлюються окремо. При цьому повний архів робиться один раз. Потім при архівації інших сайтів, вам треба буде виключити ядро та бази даних через <b>експертні</b> налаштування. Якщо відновлення робиться на іншому сервері, символьні посилання на папки <b>bitrix</b> та <b>upload</b> вам необхідно буде створити вручну.";
...
$MESS["DUMP_MAIN_BXCLOUD_INFO"] = "Компанія «1С-Битрикс» безкоштовно надає місце в хмарі для зберігання трьох резервних копій на кожну активну ліцензію. Доступ до резервних копій здійснюється за ліцензійним ключем та паролем. Без знання пароля ніхто, включаючи співробітників «1С-Бітрікс», не зможе отримати доступ до ваших даних.";
...
$MESS["DUMP_ERR_BIG_BACKUP"] = "Розмір резервної копії перевищує вашу квоту в хмарі &quot;1С-Бітрікс&quot;. Архів збережений локально.";
$MESS["DUMP_BACK"] = "назад";
$MESS["DUMP_RETRY"] = "Спробувати ще раз";
$MESS["MAIN_DUMP_ERR_DELETE"] = "Не можна вручну видалити файли зі хмарного сховища &quot;1С-Бітрікс&quot;. Старі копії автоматично видаляються після завантаження нових.";
$MESS["ERR_NO_BX_CLOUD"] = "Не встановлено модуль хмарних сервісів &quot;1С-Бітрікс&quot;";
...
$MESS["AUTO_EXEC_FROM_BITRIX"] = "через хмарний сервіс \"1С-Бітрікс\"";
...
$MESS["DUMP_CHECK_BITRIXCLOUD"] = "Стан завдання можна перевірити на <a href=\"#LINK#\">сторінці</a> хмарного сервісу \"1С-Бітрікс\"";
$MESS["DUMP_WARN_NO_BITRIXCLOUD"] = "Неможливо включити автоматичне резервне копіювання: необхідний модуль хмарних сервісів \"1С-Бітрікс\" або агенти повинні виконуватися на cron.";
...
Хмарний моніторинг &quot;1С-Бітрікс&quot; відкриє спеціальну посилання на вашому сайті в зазначений час щоб створити резервну копію. Посилання містить секретний код, який дозволяє створити резервну копію, але не дає доступ до даних сайту. Доступ до адміністративної частини не потрібен, може бути закритий за IP. 

За замовчуванням резервна копія відправляється до хмари &quot;1С-Бітрікс&quot;, де в зашифрованому вигляді зберігається в декількох примірниках. Це надійний і безпечний спосіб зберегти ваші дані. 

Якщо хмарні сервіси &quot;1С-Бітрікс&quot; недоступні, а агенти виконуються на cron, буде створюватися локальна копія через cron.";
?>
