...
$MESS["MAIN_OPTION_HTML_CACHE"] = "Generación de página HTML ";
$MESS["MAIN_TAB_3"] = "Eliminar Archivos de Cache";
$MESS["MAIN_TAB_2"] = "Caché HTML";
...
$MESS["MAIN_OPTION_HTML_CACHE_WARNING"] = "Atención!  Los módulos de Estadística y/o Publicidad se han detectado. La data en cache HTML será seguida incorrectamente.";
$MESS["MAIN_OPTION_HTML_CACHE_WARNING_TRANSID"] = "Atención! el parámetro session.use_trans_sid está habilitado. El caché HTML no funcionará.";
$MESS["MAIN_OPTION_HTML_CACHE_ON"] = "Caché HTML está encendido";
$MESS["MAIN_OPTION_HTML_CACHE_OFF"] = "Caché HTML está apagado";
$MESS["MAIN_OPTION_HTML_CACHE_BUTTON_OFF"] = "Deshabilitar caché HTML";
$MESS["MAIN_OPTION_HTML_CACHE_BUTTON_ON"] = "Habilitar caché HTML";
$MESS["MAIN_OPTION_HTML_CACHE_OPT"] = "Configuraciones de cache HTML";
$MESS["MAIN_OPTION_HTML_CACHE_INC_MASK"] = "Máscara de Inclusión ";
$MESS["MAIN_OPTION_HTML_CACHE_EXC_MASK"] = "Máscara de Exclusión";
$MESS["MAIN_OPTION_HTML_CACHE_QUOTA"] = "Espacio de disco (MB)";
$MESS["MAIN_OPTION_HTML_CACHE_SUCCESS"] = "Modo caché HTML fue cambiado con éxito.";
$MESS["MAIN_OPTION_HTML_CACHE_STAT"] = "Estadísticas";
$MESS["MAIN_OPTION_HTML_CACHE_STAT_HITS"] = "Golpes de cache";
$MESS["MAIN_OPTION_HTML_CACHE_STAT_MISSES"] = "Perdidos en el cache";
$MESS["MAIN_OPTION_HTML_CACHE_STAT_QUOTA"] = "Limpieza del cache causada por falta de espacio en el disco";
$MESS["MAIN_OPTION_HTML_CACHE_STAT_POSTS"] = "Limpieza de Caché causada por falta de espacio en el disco";
$MESS["MAIN_OPTION_HTML_CACHE_SAVE"] = "Guardar la configuración de caché HTML";
$MESS["MAIN_OPTION_HTML_CACHE_RESET"] = "Aplicar ajustes por defecto";
$MESS["cache_admin_note4"] = "<p>El caché HTML es recomendado para secciones del sitio que cambian con poca frecuencia y son mayormente vista por visitantes anónimos. Los siguientes procesos se llevan a cabo cuando el caché HTML es habilitado: </p>
...
<li>Si los datos son enviados desde las páginas públicas del sitio (por ejemplo, la adición de comentarios o votos), entonces sólo las partes seleccionadas del caché serán eliminadas;</li>
</ul>
...
$MESS["cache_admin_note1"] = "<p>Usando el modo Autocache la velocidad de su sitio se incrementará increiblemente!</p>
...
<p>Componentes con la configuración <i>\"Caché\"</i> y con el tiempo de cahé superior a 0 (cero), trabajarán en el modo caché.</p>
