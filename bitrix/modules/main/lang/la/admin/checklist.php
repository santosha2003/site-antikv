...
$MESS["CL_MANUAL_MINI"] = "<p>Para enviar el proyecto a  Bitrix Inc., usted debe aprobar las pruebas obligatorias restantes. El estatus de esas pruebas puede ser \"Desaprobado\" (prueba autom&aacute;tica desaprobada), o \"Pendiente\" (estas necesitar&aacute;n ser revisadas manualmente). Para aprobar pruebas desaprobadas o pendientes, lea las recomendaciones e investigue acerca del error y sus detalles.</p>
<p>En ese punto, usted tiene dos opciones:</p>
<ol>
  <li>resuelva los errores y ejecute nuevamente el test, o</li>
	<li>si usted se inclina a considerar el test como aprobado debido a que hay factores que afectan el resultado del test, usted puede dejar un comentario que ser&aacute; leido por uno de nuestros especialistas, luego cambie el estatus del test al estatus aprobado.</li>
</ol>";
...
$MESS["CL_MANUAL_TEST"] = "<p> La lista de verificaci&oacute;n de control de calidad de implementaci&oacute;n contiene recomendaciones proporcionadas por Bitrix Inc. a las que un desarrollador web tiene que adherirse al momento de realizar la integraci&oacute;n y despliegue de cualquier proyecto web.</p> 
<p>Estas recomendaciones abarcan todas las etapas de desarrollo, desde el diseño de la plantilla de la soluci&oacute;n web, las pruebas de estrés, la auditoría de seguridad, etc. y se basan en las mejores prácticas y técnicas desarrolladas por Bitrix Inc. para soluciones web de alta carga. Respete las recomendaciones de esta lista de control para as&iacute; lograr un mejor rendimiento, alta seguridad y control de su proyecto web, y reducir los riesgos tecnológicos y costos de mantenimiento.</p> 
<p> Las recomendaciones que se recogen en las pruebas que componen este examen se agrupan en dos grupos: obligatorias y opcionales. Las pruebas obligatorias son fundamentalmente cualitativas y cr&iacute;ticas por lo tanto deben ser aprobadas de manera obligatoria. Las pruebas opcionales mejorar&aacute;n la calidad final del proyecto y el superar estar pruebas es altamente recomendado. Algunas pruebas son automáticas. 
<p>El proyecto está listo para su liberaci&oacute;n si los nodos de la lista son de color verde. 
<p>Utilice la siguiente rutina para preparar un proyecto para su liberación. 

<ol >   <li> El desarrollador comienza autotesting. El sistema ejecuta las pruebas una a una y se marca cada uno de las pruebas autom&aacute;ticas como aprobado o no aprobado.</li> <li>El desarrollador revisa cada uno de los autotests no aprobados, corrige los problemas y reinicia el autotest de las pruebas no aprobadas. La prueba pueden ser omitidas de forma manual de ser requerido.</li> <li>El desarrollador revisa cada una de las pruebas manuales y las marca como \"aprobado\" o \"desaprobado\".</li>
<li>El desarrollador deber&aacute; proporcionar su informaci&oacute;n personal y de la empresa en el item de lista de verificación correspondiente. </li>
...
<li>El desarrollador libera el proyecto y lo añade al archivo. </li></ol>
  <p> Cualquier actualizaci&oacute;n posterior importante deber&aacute; ser liberada como un proyecto independiente utilizando la lista de control de calidad. Esto asegurará de la calidad y la robustez del proyecto . 
  <p>  ";
...
$MESS["CL_SAVE_SEND_REPORT_HINT"] = "Cuando usted revise su proyecto en el programa de evluación de Calidad de Bitrix Inc, el sistema sólo envía los resultados de las pruebas y los datos de contacto del dueño del proyecto. Si usted desea proporcionar información adicional, especifíquela como comentarios.";
...
$MESS["CL_REPORT_SENDED"] = "Se ha enviado el informe a Bitrix Inc.";
...
<p><b>La segunda etapa es el envío del proyecto a Bitrix Inc.: Encuesta al dueño del proyecto.</b><br>
