...
$MESS["MAIN_OPTION_HTML_CACHE"] = "Geração de página HTML";
...
$MESS["MAIN_OPTION_HTML_CACHE_WARNING"] = "Atenção! Os módulos de estatísticas e/ou de publicidade foram detectados. Os dados no cache HTML serão monitorados de forma incorreta.";
$MESS["MAIN_OPTION_HTML_CACHE_WARNING_TRANSID"] = "Atenção!  Parâmetro session.use_trans_sid está ativado. Cache HTML não funcionará.";
$MESS["MAIN_OPTION_HTML_CACHE_ON"] = "Cache de HTML está ligado";
$MESS["MAIN_OPTION_HTML_CACHE_OFF"] = "Cache de HTML está desligado";
$MESS["MAIN_OPTION_HTML_CACHE_BUTTON_OFF"] = "Desativar cache HTML";
$MESS["MAIN_OPTION_HTML_CACHE_BUTTON_ON"] = "Ativar cache HTML";
$MESS["MAIN_OPTION_HTML_CACHE_OPT"] = "Configurações de cache de HTML";
$MESS["MAIN_OPTION_HTML_CACHE_INC_MASK"] = "Máscara de inclusão";
$MESS["MAIN_OPTION_HTML_CACHE_EXC_MASK"] = "Máscara de exclusão";
...
$MESS["MAIN_OPTION_HTML_CACHE_STAT"] = "Estatísticas";
$MESS["MAIN_OPTION_HTML_CACHE_STAT_HITS"] = "Acessos ao cache";
$MESS["MAIN_OPTION_HTML_CACHE_STAT_MISSES"] = "Erros ao cache";
$MESS["MAIN_OPTION_HTML_CACHE_STAT_QUOTA"] = "Limpezas de cache causadas pela falta de espaço em disco";
$MESS["MAIN_OPTION_HTML_CACHE_STAT_POSTS"] = "Limpezas de cache causadas por modificação de dados";
$MESS["MAIN_OPTION_HTML_CACHE_SAVE"] = "Salvar as configurações de cache HTML";
$MESS["MAIN_OPTION_HTML_CACHE_RESET"] = "Aplicar configurações padrão";
