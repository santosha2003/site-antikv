<?
$MESS ['INS_TITLE'] = "Installing \"Bitrix Site Manager #VERS#\"";
...
$MESS ['SC_WEBSERVER_VER_ER'] = "Your web-server's version does not meet the Bitrix requirements";
$MESS ['SC_WEBSERVER_VER_NONE'] = "Can not find out your web-server's version";
$MESS ['SC_PHP_VER_ER'] = "Your PHP's version does not meet the Bitrix requirements";
...
$MESS ['INS_LICENSE_NOTE'] = "If you have purchased the system, please enter the license key that you have recieved by e-mail. If you plan to install the product for evaluation purposes, please leave the value DEMO.";
...
$MESS ['INS_HOST_DESCR_MSSQL'] = "For example: DRIVER=SQL Native Client; UID=sa; DATABASE=DATABASE_NAME; WSID=BX; PWD={password}; APP=Microsoft Data Access Components;SERVER=BX";
$MESS ['INS_USER'] = "User:";
...
$MESS ['COPYRIGHT'] = "Copyright &copy; 2001-2005 Bitrix";
...
$MESS ['FIRST_PAGE'] = "<font class=\"text\">
The setup wizard will test your software compatibility and install Bitrix Site Manager.
<br><br>
After the installation completes, you can start using your site.
<br><br>
Using the SiteUpdate system you can update your copy and use the up-to-date version of Bitrix Site Manager.
<br><br>
You can get more details on Bitrix Site Manager here: <a href=\"http://www.bitrixsoft.com/?r1=bsm4trial&r2=install\">http://www.bitrixsoft.com</a>
<br><br>
Should you have any questions on the installation process, please do not hesitate to contact the <a href=\"http://www.bitrixsoft.com/support/?r1=bsm4trial&r2=installsup\">Bitrix technical support departament</a> .
</font>";
$MESS ['GO_TO_CONTROL'] = "จัดการเว็บไซต์";
$MESS ['GO_TO_REGISTER'] = "ลงทะเบียนโปรแกรม";
$MESS ['GO_TO_REGISTER_DESCR'] = "Registering your copy of Pegasus Site Manager entitles you to:
<ul><li>download and install the latest updates of the system;</li><li>send requests to the Bitrix helpdesk service, which will allow you to obtain timely advices on any question regarding the system installation and functioning;</li><li>activate your own account on the Pegasus private forum. This will enable you to discuss questions with other users, Bitrix partners as well as the Helpdesk staff.</li></ul>";
$MESS ['GO_TO_VIEW'] = "ดูเว็บไซต์";
$MESS ['ERR_NO_DATABSEL'] = "ยังไม่ได้เลือกฐานข้อมูล";
...
$MESS ['INS_DB_SELECTION'] = "เลือกประเภทฐานข้อมูล";
$MESS ['INS_DB_PROMT'] = "ฐานข้อมูล";
$MESS ['INS_DB_PROMT_ALT'] = "ติดตั้งฐานข้อมูลแล้ว";
