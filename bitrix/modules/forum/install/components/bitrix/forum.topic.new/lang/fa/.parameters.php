<?
$MESS["F_INDEX_TEMPLATE"] = "Foums List page";
...
$MESS["F_MESSAGE_TYPE"] = "Message action";
$MESS["F_DEFAULT_PATH_TO_SMILE"] = "Path to Smiles folder (root relative)";
$MESS["F_DEFAULT_PATH_TO_ICON"] = "Path to Icons folder (root relative)";
