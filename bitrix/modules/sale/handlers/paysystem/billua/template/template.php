...
<b><?=Loc::getMessage('SALE_HPS_BILLUA_TITLE', array('#PAYMENT_NUMBER#' => htmlspecialcharsbx($payment->getField('ACCOUNT_NUMBER')), '#PAYMENT_DATE#' => $params["DATE_INSERT"])); ?></b>
<br>
<br>
...
<table class="acc">
	<tr>
		...
		<td style="padding-left: 4pt; ">
			...
			<br>
			<?=Loc::getMessage('SALE_HPS_BILLUA_SELLER_COMPANY_RS')?> <?=$params["SELLER_COMPANY_RS"]; ?>,
			...
			<br>
			<?=Loc::getMessage('SALE_HPS_BILLUA_SELLER_COMPANY_ADDRESS')?>: <?=$params["SELLER_COMPANY_ADDRESS"]; ?>,
	...
	<tr>
		...
		<td style="padding-left: 4pt; ">
			...
			<br>
			<?=Loc::getMessage('SALE_HPS_BILLUA_BUYER_ADDRESS')?>: <?=$params["BUYER_PERSON_COMPANY_ADDRESS"]; ?>
			<? } ?>
		</td>
	</tr>
</table>
...
<div style="position: relative">
	<table class="sign">
		<tr>
			...
			<td><?=Loc::getMessage('SALE_HPS_BILLUA_POS')?>:&nbsp;</td>
