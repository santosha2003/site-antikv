...
$pdf->Write(15, CSalePdf::prepareToPdf(Loc::getMessage('SALE_HPS_BILLUA_TITLE', array('#PAYMENT_NUMBER#' => htmlspecialcharsbx($payment->getField('ACCOUNT_NUMBER')), '#PAYMENT_DATE#' => $params["DATE_INSERT"]))));
$pdf->Ln();
$pdf->Ln();
...
$pdf->MultiCell(0, 15, CSalePdf::prepareToPdf(sprintf(
	...
	$params["SELLER_COMPANY_RS"],
	$params["SELLER_COMPANY_BANK"],
...
$pdf->SetFont($fontFamily, 'B', $fontSize);
$pdf->Write(15, CSalePdf::prepareToPdf(Loc::getMessage('SALE_HPS_BILLUA_POS').': '));
