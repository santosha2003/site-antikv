<?
$MESS["SBLP_DTITLE"] = "Счет (Украинский)";
...
$MESS["SBLP_ORDER_ID"] = "Код оплаты";
$MESS["SBLP_ACC_SUPPLI"] = "Виписав(ла)";
$MESS["SBLP_ACC_POS_SUPPLI"] = "Посада";

$MESS["SBLP_ACC_SIGN_SUPPLI"] = "Підпис (рекомендовані розміри 200x50px)";

$MESS["SBLP_PRINT"] = "Печатка (рекомендовані розміри 150x150px)";
$MESS["SBLP_PRINT_DESC"] = "Зображення печатки постачальника на сайті";

$MESS["SBLP_BACKGROUND"] = "Фон (рекомендовані розміри 800x1120px)";
