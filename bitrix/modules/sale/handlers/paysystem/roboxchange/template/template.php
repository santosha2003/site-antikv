<?
	...
	$crc = md5($params['ROBOXCHANGE_SHOPLOGIN'].":".$params['PAYMENT_SHOULD_PAY'].":".$params['PAYMENT_ID'].":".$params['ROBOXCHANGE_SHOPPASSWORD'].':SHP_BX_PAYSYSTEM_CODE='.$params['BX_PAYSYSTEM_CODE'].':SHP_HANDLER=ROBOXCHANGE');
?>
