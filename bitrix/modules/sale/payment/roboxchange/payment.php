...
$crc = md5($mrh_login.":".$out_summ.":".$inv_id.":".$mrh_pass1.":shp_payment_id=".$paymentId);
...
<?=GetMessage("PYM_TO_PAY")?> <b><?echo SaleFormatCurrency($out_summ, CSalePaySystemAction::GetParamValue("CURRENCY"))?></b>
<p>
...
<input type="hidden" name="shp_payment_id" value="<?=$paymentId;?>">
<?
