...
BX.SocNetLogDestination.BXfpSelectCallback = function(params)
{
	if (!BX.findChild(params.containerInput, { attr : { 'data-id' : params.item.id }}, false, false))
	{
		...
		var el = BX.create("span", {
			...
			children: [
				...
				(
					prefix == 'UE'
					&& typeof params.item.params != 'undefined'
					&& typeof params.item.params.name != 'undefined'
						? BX.create("input", {
							attrs : {
								'type' : 'hidden',
				...
				(
					prefix == 'UE'
					&& typeof params.item.params != 'undefined'
					&& typeof params.item.params.lastName != 'undefined'
						? BX.create("input", {
							attrs : {
								'type' : 'hidden',
	...
	BX.SocNetLogDestination.BXfpSetLinkName({
		...
		tagInputName: params.tagInputName,
