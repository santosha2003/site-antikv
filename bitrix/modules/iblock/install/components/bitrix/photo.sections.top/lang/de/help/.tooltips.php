...
$MESS ['PROPERTY_CODE_TIP'] = "Zwischen den Informationsblock-Eigenschaften kann man die wählen, die in TOP Listen angezeigt werden. Beim Auswählen des Punktes (nicht gewählt)-> und ohne die Angabe der Feld ID's in den unteren Zeilen, werden die Eigenschaften in TOP Listen nicht angezeigt.";
...
$MESS ['SECTION_SORT_FIELD_TIP'] = "Hier wird das Feld angegeben, nach dem die Sortierung der Bereiche erfolgt.";
...
$MESS ['ELEMENT_COUNT_TIP'] = "Maximale Anzahl Fotos, die in jedem Bereich angezeigt werden";
...
$MESS ['LINE_ELEMENT_COUNT_TIP'] = "Anzahl der Fotos in einer Tabellenzeile";
