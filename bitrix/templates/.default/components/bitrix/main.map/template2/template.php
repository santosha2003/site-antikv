...
<div class="catalog-section-list">
		...
		?>
			...
			<ul>
			<?endif?>
				<? $name = str_replace('&lt;br&gt;',' ',$arItem["NAME"]);?>
			<?if (array_key_exists($index+1, $arResult["arMap"]) && $arItem["LEVEL"] < $arResult["arMap"][$index+1]["LEVEL"]):?>
				<li style="list-style: circle;"><a href="<?=$arItem["FULL_PATH"]?>"><?=$name?></a><?if ($arParams["SHOW_DESCRIPTION"] == "Y" && $arItem["DESCRIPTION"] <> '') {?><div><?=$arItem["DESCRIPTION"]?></div><?}?>
					<ul> <br>
			<?else:?>
					<li style="list-style: circle;"><a href="<?=$arItem["FULL_PATH"]?>"><?=$name?></a><?if ($arParams["SHOW_DESCRIPTION"] == "Y" && $arItem["DESCRIPTION"] <> '') {?><div><?=$arItem["DESCRIPTION"]?></div><?}?></li>
			<?endif?>
