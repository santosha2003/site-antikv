...
*/
   ...
   function ImageUpdate(&$arFields) {
      ...
      //То же самое, указываем ID ИБ
	   if ($arFields["IBLOCK_ID"] == 4 or ($arFields["IBLOCK_SECTION"][0]== 529) or  ($arFields["IBLOCK_SECTION"][0]== 531)or ($arFields["IBLOCK_SECTION"][0]== 531)) {
