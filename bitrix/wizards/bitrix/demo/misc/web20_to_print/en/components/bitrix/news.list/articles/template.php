...
<?foreach($arResult["ITEMS"] as $arItem):?>
	<p class="news-item">
		...
		<?if (isset($arItem["DISPLAY_PROPERTIES"]["FORUM_MESSAGE_CNT"])):?>
			<span class="news-date-time">|&nbsp;<img src="<?=$templateFolder?>/images/comments.gif" width="10" height="10" border="0" alt="">&nbsp;Comments: <?=$arItem["DISPLAY_PROPERTIES"]["FORUM_MESSAGE_CNT"]["VALUE"]?></span>
		<?endif?>

		<?if (isset($arItem["DISPLAY_PROPERTIES"]["rating"])):?>
			<span class="news-date-time">|&nbsp;<img src="<?=$templateFolder?>/images/rating.gif" width="11" height="11" border="0" alt="">&nbsp;Rating: <?=$arItem["DISPLAY_PROPERTIES"]["rating"]["VALUE"]?></span>
		<?endif?>
	</p>
<?endforeach;?>
