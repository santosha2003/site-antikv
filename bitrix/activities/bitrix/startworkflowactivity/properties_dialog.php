...
<tr>
	...
	<td width="60%">
		<input type="text" name="document_id" id="id_document_id" value="<?= htmlspecialcharsbx($documentId) ?>" size="20" />
		<input type="button" value="..." onclick="BPAShowSelector('id_document_id', 'string');" />
	</td>
</tr>
<tr>
