...
$MESS["ALBUM_PHOTO_WIDTH_TIP"] = "Spacifies the size of the album cover.";
$MESS["ALBUM_PHOTO_THUMBS_WIDTH_TIP"] = "Spacifies the size of the album thumbnail image.";
...
$MESS["SET_TITLE_TIP"] = "Check this option to set the page title either to <b><album_name> (select cover)</b>.";
?>