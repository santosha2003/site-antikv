...
$MESS["IBLOCK_TYPE_TIP"] = "Seleccione aquí uno de los tipos de información existentes bloque. Haga clic en <b><i>OK</i></b> para cargar los blocks de información del tipo seleccionado. Si usted selecciona <b><i>(other)</i></b>,usted podrá especificar el ID del tipo del block de información en el campo de al lado.";
...
$MESS["ELEMENT_ASSOC_TIP"] = "<i>none</i> - independiente; todos los elementos podrán estar disponibles para todos los usuarios;<br /><i>por el creador</i> - s{olo los elementos privados del usuario podrán ser mostrados a un usuario.";
...
$MESS["ELEMENT_ASSOC_PROPERTY_TIP"] = "Seleccione aquí una de las propiedades de bloque de información que se utiliza para distinguir y mostrar elementos como los puntos de usuario privado.";
?>