...
$MESS ['SET_TITLE_TIP'] = "Wenn diese Option aktiv ist, wird als Seitenüberschrift die eingestellte Fotogaleriebezeichnung angezeigt.";
...
$MESS ['ELEMENT_SORT_FIELD_TIP'] = "Hier wird das Feld angegeben, nach dem die Sortierung der Fotos für die Links \"Nächste\" und \"Vorherige\" erfolgt.";
...
$MESS ['ELEMENT_CODE_TIP'] = "Geben Sie den Elementcode an. Das Feld kann leer gelassen werden, wenn <i>Element ID</i> angegeben wurde.";
...
$MESS ['ELEMENT_ID_TIP'] = "Das Feld enthält den Code in dem die Element ID übergeben wird. Als Standard enthält das Feld ={\$_REQUEST[\"ID\"]}. Das Feld kann leer gelassen werden, wenn die Element ID angegeben ist.";
$MESS ['ELEMENT_SORT_ORDER_TIP'] = "Hier wird angegeben, in welcher Reihenfolge die Fotos sortiert werden.";
...
$MESS ['SECTION_ID_TIP'] = "Das Feld enthält den Code in dem die Bereichs ID übergeben wird. Als Standard enthält das Feld ={\$_REQUEST[\"SECTION_ID\"]}. Das Feld kann leer gelassen werden, wenn die Bereichs ID angegeben ist.";
?>