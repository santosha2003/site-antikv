...
$MESS["IBLOCK_SORT_TIMESTAMP"] = "Дата на последните промени";
...
$MESS["IBLOCK_ELEMENT_SORT_FIELD_NEXT_PREV_LINK"] = "Поле за сортиране на снимки (с използването на връзките \"след.\" и \"прег.\")";
$MESS["IBLOCK_ELEMENT_SORT_ORDER_NEXT_PREV_LINK"] = "Ред за сортиране на снимки (с използването на връзките \"след.\" и \"прег.\")";
...
$MESS["CP_BPD_SET_STATUS_404"] = "Посочвай статус 404, ако не е намерен елемент или раздел";
$MESS["CP_BPD_BROWSER_TITLE"] = "Поставете заглавие за прозореца на браузъра от свойствата";
$MESS["CP_BPD_CACHE_GROUPS"] = "С отчитане правата за достъп";
?>