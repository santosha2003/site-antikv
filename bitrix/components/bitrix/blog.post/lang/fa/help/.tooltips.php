...
$MESS["SET_NAV_CHAIN_TIP"] = "If checked, the name of a parent blog will be added to the navigation chain.";
$MESS["SET_TITLE_TIP"] = "If the option is active, the page title will be set to the post title.";
