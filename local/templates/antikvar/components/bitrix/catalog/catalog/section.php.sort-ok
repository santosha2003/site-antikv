...
<?endif?>
	...
	?>
	<div class="sort" style="margin:0 0 30px 0">
           <span style="font-size:16px">Cортировать по:</span> &nbsp;&nbsp;&nbsp;

	алфавиту: <a href="?sort=name&order=down" rel="nofollow">убыв.</a>&nbsp;&nbsp;<a href="?sort=name&order=up" rel="nofollow">возр.</a>&nbsp;&nbsp;&nbsp;
	цене: <a href="?sort=price&order=down" rel="nofollow">убыв.</a>&nbsp;&nbsp;<a href="?sort=price&order=up" rel="nofollow">возр.</a>&nbsp;&nbsp;&nbsp;
	дате добавления: <a href="?sort=date&order=down" rel="nofollow">убыв.</a>&nbsp;&nbsp;<a href="?sort=date&order=up" rel="nofollow">возр.</a>&nbsp;&nbsp;&nbsp;
