...
<?
 ...
 //log_array($arItem); //iconv //php default_charset=cp1251   charset=utf-8
...
?>
		<li<?=$className ? ' class="'.$className.'"' : ''?>>
           ...
           <td style='background:url("/local/templates/store_minimal_blue/images/left1.png") no-repeat;' width="6px;">        
            </td>

            
              <td width="25px" valign="center" style="border-top:1px solid #949cff;border-bottom:1px solid #949cff; text-align:left; background:transparent url(/local/templates/store_minimal_blue/images/5.PNG) repeat-x scroll 0 0;">          
                &nbsp<font color='blue'><b>-></b></font> 
                </td>
            <td  valign="center" style="border-top:1px solid #949cff;border-bottom:1px solid #949cff; text-align:left; background:transparent url(/local/templates/store_minimal_blue/images/5.PNG) repeat-x scroll 0 0;">
  
            <a<?if ($arItem['SELECTED']):?> class="selected"<?endif?> href="<?=$arItem["LINK"]?>"><?=$arItem["TEXT"]?></a>
            </td>

            <td width="6px" style='background:url("/local/templates/store_minimal_blue/images/right1.png") no-repeat;'>
		 </td>
         </tr></table>
        </li>
<?
