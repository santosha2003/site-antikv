...
// раздел Ордена и медали: скрыть все подразделы кроме Архива
$medali_section_id = 529;
$arhiv_section_id = 1805;

foreach ($arResult['SECTIONS'] as $key => $arSection) {
  if ($arSection['ID'] != $arhiv_section_id && $arSection['IBLOCK_SECTION_ID'] == $medali_section_id) {
