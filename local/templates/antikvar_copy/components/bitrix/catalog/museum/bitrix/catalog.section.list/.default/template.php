...
//$BOLD_L_E="</span>";//"</font>";//"</font></a>";//"</font>";//\n\t</li></ul>";
	...
	?><?=$LINE_ST?> id="<?=$this->GetEditAreaId($arSection['ID']);?>"><a href="<?=$arSection["SECTION_PAGE_URL"]?>"><?=$BOLD_L?><?=$NAME_HTML?><?if(($arParams["COUNT_ELEMENTS"]) && ($arSection["ELEMENT_CNT"] > 0) ): ?>&nbsp;(<?=$arSection["ELEMENT_CNT"]?>)<?endif;?><?=$BOLD_L_E?></a><?
