...
$APPLICATION->SetTitle("Награды Российской империи");
?><?php $APPLICATION->IncludeComponent("bitrix:news", "awards_rus1", Array(
	"ADD_ELEMENT_CHAIN" => "N",	// Включать название элемента в цепочку навигации
		...
		"IBLOCK_TYPE" => "award_russian",	// Тип инфоблока
		...
		"PAGER_TEMPLATE" => "visual",	// Шаблон постраничной навигации
